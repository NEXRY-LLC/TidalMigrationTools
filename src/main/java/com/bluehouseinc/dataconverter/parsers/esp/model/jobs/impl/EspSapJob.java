...
public class EspSapJob extends EspAbstractJob {
	...
	public enum EspSapJobOptionalStatement {
		...
		PRINTREL, PRINTREQTYPE, PRINTSPOOLNAME, PUTINOUTBOX, RECIPIENT, RECIPIENTBCC, RECIPIENTCC, RECIPIENTEXPRESS, RECIPIENTFORWARD, RECIPIENTPRINT, RECIPIENTTYPE, RFCDEST, SAPCLIENT, SAPEMAILADDR, SAPFAILUREMSG,
